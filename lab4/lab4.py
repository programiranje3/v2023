...
The function also receives a named argument "squared" with the default value False, which 
determines if each numeric value should be used as given or its square value should be used instead. 
...
For a funny illustration, check this page: 
